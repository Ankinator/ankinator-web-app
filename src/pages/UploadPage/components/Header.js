        ...
        <Navbar style={{ background: 'linear-gradient(to left, rgba(42, 152, 225, 0.7), rgba(167, 213, 243, 0.7))' }} expand="lg">
            <Container style={{ maxWidth: "100%", display: "flex" }}>
                ...
                <Nav className="ms-auto">
                    <Button style={{ backgroundColor: 'transparent', borderColor: "transparent", visibility: "hidden"}}><img alt="" src={Profil} style={{ marginRight: 5, marginLeft: 10 }} className="d-inline-block align-top" /></Button>
                </Nav>
            </Container>
        </Navbar>
    )
